    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.10)]">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold text-[#1F1F1F]">Aceptar invitación</h1>
          <p className="mt-1 text-sm text-gray-500">
            Creá tu contraseña para activar tu cuenta y empezar a usar el sistema.
          </p>
        </div>

        {!token && (
          <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
            El link de invitación no es válido. Pedile al administrador que te reenvíe la invitación.
          </div>
        )}
